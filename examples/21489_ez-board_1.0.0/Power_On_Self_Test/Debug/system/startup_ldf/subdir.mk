...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="21489_post" -proc ADSP-21489 -si-revision 0.2 -g -DCORE0 @includes-50d7d27ec3634917eec3881b249233b5.txt -swc -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_heaptab.doj: ../system/startup_ldf/app_heaptab.c
	...
	cc21k -c -file-attr ProjectName="21489_post" -proc ADSP-21489 -flags-compiler --no_wrap_diagnostics -si-revision 0.2 -g -D_21489_EZBOARD_REV_0_2_ -DCORE0 @includes-8c84a699b96d2ee532851485de4878d2.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -swc -gnu-style-dependencies -MD -Mo "system/startup_ldf/app_heaptab.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="21489_post" -proc ADSP-21489 -si-revision 0.2 -g -DCORE0 @includes-50d7d27ec3634917eec3881b249233b5.txt -swc -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
