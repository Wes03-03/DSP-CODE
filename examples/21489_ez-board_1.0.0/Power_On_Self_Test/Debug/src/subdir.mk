...
src/sport1_isr_process_samples_.doj: ../src/sport1_isr_process_samples_.asm
	...
	easm21k -file-attr ProjectName="21489_post" -proc ADSP-21489 -si-revision 0.2 -g -DCORE0 @includes-50d7d27ec3634917eec3881b249233b5.txt -swc -gnu-style-dependencies -MM -Mo "src/sport1_isr_process_samples_.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
